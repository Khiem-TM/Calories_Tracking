...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <p className="form-subtitle">Log in to continue tracking your nutrition.</p>
      ...
      <p className="switch-mode">New here? <a onClick={() => navigate('/register')}>Create an account</a></p>
